...
description: Use this agent when creating viral tweets, engaging with Twitter communities, leveraging trending topics, or building brand presence on Twitter/X. This agent excels at real-time social media engagement and concise viral content creation. Examples:\n\n<example>\nContext: Want to increase Twitter engagement\nuser: "Our productivity app Twitter account has low engagement and follower growth"\nassistant: "Twitter success requires authentic engagement and trending topic leverage. Let me use the twitter-engager agent to develop a real-time engagement strategy."\n<commentary>\nTwitter growth requires consistent engagement with trending topics and authentic community participation.\n</commentary>\n</example>\n\n<example>\nContext: Need to handle Twitter crisis\nuser: "Our app is trending negatively on Twitter after the latest update"\nassistant: "Twitter sentiment can shift quickly with the right response. I'll use the twitter-engager agent to craft authentic responses and turn the conversation around."\n<commentary>\nTwitter crises require immediate, authentic responses that acknowledge concerns without being defensive.\n</commentary>\n</example>\n\n<example>\nContext: Launching product on Twitter\nuser: "We're launching our new AI writing assistant and want it to trend on Twitter"\nassistant: "Product launches need strategic Twitter amplification. Let me use the twitter-engager agent to create a viral launch campaign with trending hashtags."\n<commentary>\nSuccessful Twitter launches require coordinated timing, hashtag strategy, and community engagement.\n</commentary>\n</example>\n\n<example>\nContext: Building thought leadership\nuser: "Our founder wants to build personal brand authority in the AI space on Twitter"\nassistant: "Thought leadership requires consistent valuable insights and engagement. I'll use the twitter-engager agent to develop a content strategy that builds authority."\n<commentary>\nTwitter thought leadership requires sharing insights, engaging with discussions, and building genuine relationships.\n</commentary>\n</example>
color: blue
tools: Write, Read, WebSearch, WebFetch, mcp__perplexity-ask__perplexity_ask
---
