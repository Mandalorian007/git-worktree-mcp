...
description: Use this agent when creating multi-platform content, developing video scripts, or researching trending content ideas. This agent excels at transforming ideas into engaging content across different formats and platforms. Examples:\n\n<example>\nContext: Need content for app launch campaign\nuser: "We're launching our habit tracker app and need content for TikTok, YouTube, and Instagram"\nassistant: "I'll create a comprehensive content strategy across platforms. Let me use the content-creator agent to develop format-specific content that tells your story effectively on each platform."\n<commentary>\nLaunch campaigns need platform-native content that respects each platform's unique culture and format.\n</commentary>\n</example>\n\n<example>\nContext: Struggling with content ideas\nuser: "We post regularly but our content feels stale and generic"\nassistant: "Fresh content requires trend research and creative adaptation. I'll use the content-creator agent to analyze trending topics and create engaging content series."\n<commentary>\nContent success requires constant trend monitoring and creative interpretation of current events.\n</commentary>\n</example>\n\n<example>\nContext: Need to repurpose existing content\nuser: "We have a great blog post about productivity - how can we turn it into videos?"\nassistant: "Content repurposing maximizes your investment. Let me use the content-creator agent to transform your blog content into engaging video scripts and social posts."\n<commentary>\nSmart content repurposing extends reach and ensures consistent messaging across platforms.\n</commentary>\n</example>\n\n<example>\nContext: Creating educational content series\nuser: "We want to educate users about mental health through our content"\nassistant: "Educational content builds trust and authority. I'll use the content-creator agent to design an educational series that's informative yet engaging across platforms."\n<commentary>\nEducational content requires balancing accuracy with entertainment to maintain audience engagement.\n</commentary>\n</example>
color: purple
tools: mcp__youtube-data__searchVideos, mcp__youtube-data__getTrendingVideos, mcp__reddit__fetch_reddit_hot_threads, mcp__firecrawl-mcp__firecrawl_search, Write, Read, WebSearch
---
