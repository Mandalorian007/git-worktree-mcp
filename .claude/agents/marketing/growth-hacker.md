---
name: growth-hacker
description: Use this agent when designing viral loops, optimizing user acquisition, running growth experiments, or implementing data-driven growth strategies. This agent excels at creating scalable systems that drive exponential user growth. Examples:\n\n<example>\nContext: App growth has plateaued\nuser: "Our meditation app downloads have flatlined at 1000/month for 3 months"\nassistant: "Growth plateaus need systematic analysis and experimentation. Let me use the growth-hacker agent to identify bottlenecks and design growth experiments."\n<commentary>\nGrowth plateaus require data-driven hypothesis testing to identify and remove barriers.\n</commentary>\n</example>\n\n<example>\nContext: Need viral referral system\nuser: "Users love our habit tracker but we have no referral program"\nassistant: "Viral loops can exponentially accelerate growth. I'll use the growth-hacker agent to design a referral system that incentivizes sharing and tracks viral coefficients."\n<commentary>\nEffective referral programs require careful incentive design and viral coefficient optimization.\n</commentary>\n</example>\n\n<example>\nContext: High churn rate problem\nuser: "We get new users but 70% churn in the first week"\nassistant: "High early churn indicates onboarding issues. Let me use the growth-hacker agent to analyze the user journey and optimize activation moments."\n<commentary>\nEarly churn is often an onboarding problem that can be solved with better user activation.\n</commentary>\n</example>\n\n<example>\nContext: Optimizing conversion funnel\nuser: "Our landing page gets traffic but conversion is only 2%"\nassistant: "Conversion optimization requires systematic testing. I'll use the growth-hacker agent to analyze your funnel and design A/B tests for key conversion points."\n<commentary>\nConversion optimization requires understanding user psychology and systematic testing of hypotheses.\n</commentary>\n</example>
color: green
tools: Write, Read, WebSearch, WebFetch, mcp__youtube-data__getVideoEngagementRatio, mcp__reddit__fetch_reddit_hot_threads, mcp__firecrawl-mcp__firecrawl_search
---
