...
color: purple
tools: WebSearch, WebFetch, Read, Write, Grep, mcp__perplexity-ask__perplexity_ask, mcp__firecrawl-mcp__firecrawl_search, mcp__youtube-data__getTrendingVideos, mcp__reddit__fetch_reddit_hot_threads
---
